...
# How to execute:
# This program should be run on the server side.
# Do not forget to run comClient.py on after launching to connect.
...
# TODO List:
# Code is from M.Engel ("minicom.py") and needs to be adjusted, to pass on data to the next group
