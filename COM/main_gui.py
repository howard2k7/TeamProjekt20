...
selectedHoehe = StringVar()
selectedHoehe.set("Höhe 1")
selectedGeschw = StringVar()
...
hoeheeinstellen = Button(main, text="Höhe übernehmen", pady=20, padx=20, command=lambda:threading.Thread(target=hoeheEinstellen).start())
hoeheeinstellen.grid(row=2, column=1)
geschweinstellen = Button(main, text="Geschwindigkeit übernehmen", pady=20, padx=20, command=lambda:threading.Thread(target=geschwEinstellen).start())
